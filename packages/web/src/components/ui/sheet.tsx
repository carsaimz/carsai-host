/**
 * CARSAI HOST — Sheet (offcanvas sidebar) component
 *
 * A slide-in panel built on top of Radix Dialog. Used as the mobile
 * navigation sidebar across PublicLayout, DashboardLayout, and
 * AdminLayout. Renders full-height, anchored to the left or right,
 * with a backdrop overlay that closes on click.
 *
 * Usage:
...
const SheetHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      'flex flex-col space-y-1.5 border-b border-border p-4 text-left',
      className,
    )}
    {...props}
  />
